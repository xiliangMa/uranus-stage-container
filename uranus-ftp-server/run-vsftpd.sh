...
if [ ! -d /home/vsftpd/anon ]; then
    mkdir /home/vsftpd/anon
fi
chmod a-w /home/vsftpd/anon
...
if [ "$PASV_ADDRESS" = "**IPv4**" ]; then
    export PASV_ADDRESS=$(/sbin/route|awk '/default/ { print $3 }')
fi
...
export LOG_ACC='/var/log/vsftpd.log'
...
EOB
    ...
    #/usr/bin/ln -sf /dev/stdout $LOG_ACC
